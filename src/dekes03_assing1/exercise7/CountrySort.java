package dekes03_assing1.exercise7;
...
public class CountrySort {
    ...
    public static void main(String[] args) {
        ...
        Comparator<String> longestName = (String s1,String s2) -> Integer.compare(s2.length(), s1.length());       //updated
        ...
        Comparator<String> reverseAlphabetic = (String s1, String s2) -> Character.compare(s2.charAt(0), s1.charAt(0));       //updated
        ...
        Comparator<String> countAs = (String s1, String s2) -> Long.compare(
                ...
                s1.toLowerCase().chars().filter(a -> a == 'a').count());      //updated
