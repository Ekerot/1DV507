...
public interface IFerry {
    ...
    void embark(Vehicle v) throws NoRoomForVehiclesException; // Embark vehicle, warning if not enough space

    void embark(Passenger p) throws NoRoomForPassengerException; // Embark passenger, warning if not enough room
